...
export async function notifyLostFoundMatch(reporterStudentId, matchedStudentId, newItem, matchedItem, score) {
  try {
    ...
    logger.info(`Lost & Found match notification sent — Score: ${scorePercent}% — Items: "${newItem.item_name}" ↔ "${matchedItem.item_name}"`)
