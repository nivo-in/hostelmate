  ...
  return (
    <div className={styles.site} style={{ 
      ...
      <div style={{
        ...
        background: `radial-gradient(ellipse at center, ${roleColors[bgRole]}1A 0%, ${roleColors[bgRole]}0A 35%, ${roleColors[bgRole]}04 60%, transparent 75%)`,
      ...
      <div style={{
        ...
        height: '400px',
        opacity: bgDimmed ? 0.5 : 1,
        background: `radial-gradient(ellipse at center, ${roleColors[bgRole]}08 0%, transparent 65%)`,
