        ...
        <form onSubmit={handleSubmit} className="space-y-4 max-w-lg">
          <div className="flex gap-4 mb-4">
            <button
              ...
              className={`flex-1 py-2 rounded-lg text-sm font-medium transition-colors ${status === 'lost' ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-600 hover:bg-gray-100'}`}
            >
              I Lost Something
            </button>
            <button
              ...
              className={`flex-1 py-2 rounded-lg text-sm font-medium transition-colors ${status === 'found' ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-600 hover:bg-gray-100'}`}
            >
              I Found Something
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {filteredItems.length === 0 ? (
            ...
            filteredItems.map((item) => (
              <div
                key={item.id}
                className="p-6 border border-gray-100 rounded-xl hover:border-gray-300 transition-colors bg-white"
              >
