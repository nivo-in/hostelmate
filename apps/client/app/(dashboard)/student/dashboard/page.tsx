  ...
  return (
    <div className="min-h-screen bg-white p-8 max-w-5xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Card emoji="📋" title="Attendance" description="Mark your daily attendance" href="/student/attendance" />
          <Card emoji="🏖️" title="Leave Request" description="Apply for leave" href="/student/leaves" />
          <Card emoji="🔧" title="Complaints" description="Report a maintenance issue" href="/student/complaints" />
          <Card emoji="🍽️" title="Mess" description="View menu and rate meals" href="/student/mess" />
          <Card emoji="📢" title="Notices" description="Read announcements" href="/student/notices" />
          ...
          <Card emoji="💳" title="Fee Payments" description="Pay hostel and mess fees online" href="/student/payments" />
        </div>
      )}
    </div>
  )
