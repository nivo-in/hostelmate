      ...
      <section className={styles.hero}>
        <div>
          <div className={styles.heroEyebrow}>
            ...
            <span className={styles.eyebrowText}>Now with face recognition</span>
          </div>
        ...
        <div className={styles.heroVisual}>
          <div className={styles.floatingCard}>
            <div className={styles.floatingIcon} style={{background:'rgba(74,222,128,0.12)'}}>
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#4ade80" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg>
            </div>
            <div>
          ...
          <div className={styles.dashboard3d}>
          ...
          <div className={styles.floatingCard2}>
            <div className={styles.floatingIcon} style={{background:'rgba(139,92,246,0.15)'}}>
              <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#a78bfa" strokeWidth="2"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/></svg>
            </div>
            <div>
